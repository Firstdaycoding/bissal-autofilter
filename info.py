...
#main variables
API_ID = int(environ.get('API_ID', '22813702'))
API_HASH = environ.get('API_HASH', 'c30a3c5355279cdae2427bf45b5c4e45')
BOT_TOKEN = environ.get('BOT_TOKEN', '7640184396:AAHUyxwvgIkdbJlXaFMRCST8dzoti26iuS8')

ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7796407523').split()]
USERNAME = environ.get('USERNAME', "https://telegram.me/Kanhaiya_again")
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002267450992'))
QR_CODE = environ.get('QR_CODE', 'https://graph.org/file/ccb9db43e62a2e524928e.jpg')
START_IMG = environ.get('START_IMG', 'https://ibb.co/9mPWg5Dp')
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002267450992'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002267450992'))
URL = environ.get('URL', 'mytestbot-jvdfhbj.com')
STICKERS_IDS = ('CAACAgQAAxkBAAEK99dlfC7LDqnuwtGRkIoacot_dGC4zQACbg8AAuHqsVDaMQeY6CcRojME').split()
FILE_AUTO_DEL_TIMER = int(environ.get('FILE_AUTO_DEL_TIMER', '600'))
IS_VERIFY = is_enabled('IS_VERIFY', True)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002267450992'))
...
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1002267450992'))
